...
class ExitAuditApplicationRecord {
  ExitAuditApplicationRecord({
    required this.id,
  ...
  factory ExitAuditApplicationRecord.fromJson(Map<String, dynamic> json) {
    return ExitAuditApplicationRecord(
      id: _toInt(json['id']),
